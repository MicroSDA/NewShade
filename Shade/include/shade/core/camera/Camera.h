...
namespace shade
{
	...
	public:
		...
		inline glm::mat4 GetViewProjection()           const { return m_Perpective * GetView(); }
		...
		inline void MoveBackward(const float& value)							{ m_Position -= m_Forward * value; }
		...
		inline Frustum GetFrustum() const { return Frustum(GetViewProjection()); };
		// Yaw
