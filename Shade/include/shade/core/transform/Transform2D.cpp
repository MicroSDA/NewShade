...
const glm::mat4 shade::Transform2D::GetModelMatrix() const
{
	...
	glm::mat4 _RotationXMatrix = glm::rotate(glm::radians(0.0f),	glm::vec3(1.0, 0.0, 0.0));
	glm::mat4 _RotationYMatrix = glm::rotate(glm::radians(0.0f),	glm::vec3(0.0, 1.0, 0.0));
	glm::mat4 _RotationZMatrix = glm::rotate(glm::radians(m_Rotation),  glm::vec3(0.0, 0.0, 1.0));
